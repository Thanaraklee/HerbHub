                    ...
                    with stylable_container(
                        ...
                        css_styles=[
                            ...
                            button[data-testid="stPopoverButton"]:hover {{
                                background-color: white;
                                background-image: url("{encode_image_to_data_url_svg('./images/icon_button_sum_hover.svg')}");
                            }}
                            """,
                            """
                            ...
                            if st.button("Summary with AI", key="summarize_with_ai", use_container_width=True):
                                ...
                                with st.spinner('Processing... 🚀'):
                                    try:
                                        ...
                                        result_summary = 'Please try again later. 😢'
                                if result_summary:
    ...
    with body_stat_1:
        with stylable_container(
            ...
            css_styles=[
                ...
                """,
                """
                div > div > div:nth-child(2) > div > div > div[data-testid="stElementContainer"] {
                    display: none;
                }
                """
            ]
                ...
                st.markdown(f"""
                            <div>
                                <p style='color: white;font-size: 20px; font-weight: 500;padding-left: 5px;display: flex;'>
                                    ...
                                    <img src=\'{encode_image_to_data_url_svg('./images/bar.svg')}\' style="height: 30px;padding-left: 5px;">
                                </p>
                            </div>
                            """, unsafe_allow_html=True)
                        ...
                        if df_clinical_and_pharma['Count'].values.sum() > 0:
                            ...
                            options = {
                                ...
                                "xAxis": {
                                    ...
                                    "name": "หัวข้อการศึกษา/วิจัย",  
                                    "nameLocation": "middle",  
                                    "nameTextStyle": {"fontSize": 12, "padding": 20} 
                                },
                                "yAxis": {
                                    "type": "value",
                                    "name": "จำนวนการศึกษา/วิจัย",  # ชื่อแกน y
                                    "nameLocation": "middle",  # ตำแหน่งชื่อแกน y อยู่ตรงกลาง
                                    "nameTextStyle": {"fontSize": 12, "padding": 20} 
                                },
                                "series": [
                                    {
                            ...
                            st.markdown(f"""
                                        <div style='display: flex; justify-content: center; align-items: center;'>
                                            <p style='font-size: 30px; font-weight: 700; color: #999999;'>
                                                No Phamacological and Clinical data
                                            </p>
                                        </div>
                                        """, unsafe_allow_html=True)             
                        ...
                        if stat_drug['Part'][0]:
                            ...
                            options = {
                                ...
                                "color": [
                                    ...
                                    "#ffffcc", "#e5d8bd", "#f4cae4", "#e2d4e1", "#f1e2a4"
                                ],  # Define the pastel1 colors globally
                                "series": [
                                    {
                                        "type": "pie",
